...
<div class="container mx-auto px-4 py-8 max-w-6xl">
	...
	<div class="flex flex-col items-center space-y-6 mb-12">
		<div class="relative">
			{#if items.length > 0}
				<Spinner {items} {isSpinning} {rotation} size={800} />
			{:else}
				<div
	...
	<!-- Items Management Section (Centered Below) -->
	<div class="*:w-1/2 space-y-6 flex flex-wrap *:first:pr-4 *:last:pl-4">
		<div>
